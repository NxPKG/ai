...
- [next-openai](https://github.com/khulnasoft-lab/ai/tree/main/examples/next-openai)
- [next-replicate](https://github.com/khulnasoft-lab/ai/tree/main/examples/next-replicate)
- [next-huggingface](https://github.com/khulnasoft-lab/ai/tree/main/examples/next-huggingface)
- [next-langchain](https://github.com/khulnasoft-lab/ai/tree/main/examples/next-langchain)
