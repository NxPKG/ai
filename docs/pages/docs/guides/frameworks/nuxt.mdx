...
- [nuxt-openai](https://github.com/khulnasoft-lab/ai/tree/main/examples/nuxt-openai)
- [nuxt-langchain](https://github.com/khulnasoft-lab/ai/tree/main/examples/nuxt-langchain)
